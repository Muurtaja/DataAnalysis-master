...
import com.myapp.dataanalysis.call_log.uniqueCallLog;
...
public class HomeActivity extends Activity {
    ...
    Button btnCallLog,btnSmsLog,btnOutGoingSms, btnUniqueCallDuration;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUniqueCallDuration =findViewById(R.id.btn_unique_call_log);
        ...
        btnUniqueCallDuration.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent = new Intent(getApplicationContext(),uniqueCallLog.class);
                startActivity(intent);
            }
        });
    }
